    ...
    try:
        ...
        if classification == "CONVERSATIONAL":
            ...
            response = client.models.generate_content(
                ...
                TASK: Generate a list of course names that would be relevant to the student's query. Remember to always consider their requirements. For example if a student is studying MechE, they would have different requirements than someone studying art or CS.
                
                IMPORTANT TO REMEMBER: Always keep in mind requirements for their major. someone doing M&T will have different requirements than someone in the school of arts and sciences. Different majors will also have different requirements. 
            ...
            response = client.models.generate_content(
                ...
                contents = f"""
                    ...
                    Always keep in mind requirements for their major. someone doing M&T will have different requirements than someone in the school of arts and sciences. Different majors will also have different requirements. 
                """
            )
